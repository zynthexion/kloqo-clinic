        ...
        <div className="flex h-20 items-center justify-center p-4 shrink-0">
            <Link href="/" className="flex items-center gap-3">
                <div className="w-10 h-10 shrink-0 group-hover:hidden transition-opacity duration-200">
                    <Image src="https://firebasestorage.googleapis.com/v0/b/kloqo-clinic-multi-33968-4c50b.firebasestorage.app/o/kloqo_Logo_twest.png?alt=media&token=478a0eb1-1a51-4513-adce-d0fcb0c392a7" alt="Kloqo Icon" width={40} height={22} />
                </div>
