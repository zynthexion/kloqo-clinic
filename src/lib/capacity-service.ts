 ...
 * Capacity Service
 * 
 * Handles 70/30 split calculations for A tokens and walk-ins
 */
 ...
 * @param capacityRatio Ratio for advanced tokens (default 0.7 = 70%)
...
/**
 * Check if a slot index is in the advanced token zone (70% zone)
 * 
 * @param slotIndex The slot index to check
 * @param totalSlots Total number of slots in the session
 * @param capacityRatio Ratio for advanced tokens (default 0.7)
...
/**
 * Check if A token booking is allowed (within 70% capacity)
 * 
